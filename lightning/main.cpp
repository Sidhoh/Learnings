...
int main()
{
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		projection = glm::perspective(glm::degrees(150.0f), (float)SCR_WIDTH /(float)SCR_HEIGHT, 0.1f, 100.0f);
		...
		lightPos = glm::vec3(lightX, lightZ, 1.0f);

		ourShader.use();
		const glm::vec3 ObjColorValue(1.0f, 0.0f, 0.31f);
		const glm::vec3 LightColorValue(1.0f, 1.0f, 1.0f); 
		ourShader.setVec3("objectColor", ObjColorValue);
		ourShader.setVec3("lightColor", LightColorValue);
		ourShader.setVec3("lightPos", lightPos); 
		ourShader.setVec3("viewPos", cameraPos);
		ourShader.setVec3("material.ambient", glm::vec3(1.0f, 0.5, 0.31f));
		ourShader.setVec3("material.diffuse", glm::vec3(1.0f, 0.5, 0.31f));
		...
		ourShader.setVec3("light.diffuse", glm::vec3(0.5f, 0.5f, 0.5f)); // darkened
		...
		model = glm::rotate(model, glm::radians(angle) * timeValue, glm::vec3(1.0f, 0.0f, 0.5f));
